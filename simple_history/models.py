...
from simple_history import register # import register
...
class HistoricalRecords(object):
    ...
    def __init__(
        ...
        using=None,
        m2m_fields=None #add many to many 
    ):
        ...
        self.using = using
        self.m2m_fields = m2m_fields #add m2m
    ...
    def contribute_to_class(self, cls, name):
        ...
        self.setup_m2m_history(cls) #add setup
    ...
    def setup_m2m_history(self, cls): #add m2m function
    ...
    def finalize(self, sender, **kwargs):
        ...
        models.signals.m2m_changed.connect(self.m2m_changed, sender=sender, weak=False)#change for m2m
    ...
    def m2m_changed(self, action, instance, sender, **kwargs):#add the function for m2m
